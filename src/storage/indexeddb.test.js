...
describe('indexeddb repository', () => {
  ...
  describe('database initialization', () => {
    it('creates the documented schema at version 1', async () => {
      const repo = makeRepo()
      ...
      expect(Array.from(linksStore.indexNames)).toEqual(expect.arrayContaining(['by-createdAt', 'by-folderId', 'by-category']))
      db.close()
    })
  ...
  describe('folder operations', () => {
    it('persists folders and deletes by id', async () => {
      ...
      expect(folders[0]).toEqual({ id: 'f1', name: 'Work', createdAt: '2024-02-02T00:00:00.000Z' })
